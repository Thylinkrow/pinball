#ifndef _ROS_turtlebot_arm_object_manipulation_ObjectDetectionGoal_h
#define _ROS_turtlebot_arm_object_manipulation_ObjectDetectionGoal_h
...
namespace turtlebot_arm_object_manipulation
{
  ...
  class ObjectDetectionGoal : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "turtlebot_arm_object_manipulation/ObjectDetectionGoal"; };
